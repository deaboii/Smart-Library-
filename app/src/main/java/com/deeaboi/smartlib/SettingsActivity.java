...
public class SettingsActivity extends AppCompatActivity
{
    ...
    private EditText fullNameEditText, userPhoneEditText, rollEditText;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        rollEditText = (EditText) findViewById(R.id.Setting_roll_number);
        ...
        userInfoDisplay(profileImageView, fullNameEditText, userPhoneEditText, rollEditText);
    ...
    private void updateOnlyUserInfo()
    {
        ...
        userMap. put("roll", rollEditText.getText().toString());
    ...
    private void userInfoSaved()
    {
        ...
        else if (TextUtils.isEmpty(rollEditText.getText().toString()))
        {
            Toast.makeText(this, "Roll is mandatory.", Toast.LENGTH_SHORT).show();
        }
